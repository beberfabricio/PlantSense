...
export const useGroupStore = create((set) => ({
  ...
  fetchGroups: () => {
    ...
    axios.get('https://localhost:7246/groups', {
        headers: {
  ...
  fetchGroupById: (id) => {
    ...
    axios.get(`https://localhost:7246/groups/${id}`, {
        headers: {
          Authorization: GetToken()
        }
      })
  ...
  addGroup: (data, navigate) => {
    ...
    axios.post(`https://localhost:7246/groups`, data, {
        headers: {
          Authorization: GetToken()
        }
      })
  ...
  updateGroup: (data, id, navigate) => {
    ...
    axios.put(`https://localhost:7246/groups/${id}`, data, {
        headers: {
          Authorization: GetToken()
        }
      })
  ...
  deleteGroup: (id, fetchGroups) => {
    ...
    axios.delete(`https://localhost:7246/groups/${id}`, {
        headers: {
          Authorization: GetToken()
        }
      })
