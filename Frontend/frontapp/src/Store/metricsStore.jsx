...
export const useMetricsStore = create((set) => ({
  ...
  fetchScansByMonthAmount: () => {
    axios.get('https://localhost:7246/metrics/scanamounts', {
        headers: {
  ...
  fetchHealthyPlantByMonthAmount: () => {
    axios.get('https://localhost:7246/metrics/healthyplantsamount', {
        headers: {
          Authorization: GetToken()
        }
      })
  ...
  fetchCreatedUsersByMonthAmount: () => {
    axios.get('https://localhost:7246/metrics/createdusersamount', {
        headers: {
          Authorization: GetToken()
        }
      })
  ...
  fetchLoginByMonthAmount: () => {
    axios.get('https://localhost:7246/metrics/loginamount', {
        headers: {
          Authorization: GetToken()
        }
      })
