...
export const useHealthAssesmentsStore = create((set) => ({
  ...
  fetchHealthAssesments: () => {
    ...
    axios.get('https://localhost:7246/plants/healthassesment', {
        headers: {
  ...
  fetchHealthAssesmentById: (id) => {
    ...
    axios.get(`https://localhost:7246/plants/healthassesment/${id}`, {
        headers: {
          Authorization: GetToken()
        }
      })
  ...
  addHealthAssesment: (data, fetchHealthAssesments) => {
    ...
    axios.post('https://localhost:7246/plants/healthassesment', data, {
      headers: {
        Authorization: GetToken()
      }
    })
