...
export const usePlantStore = create((set) => ({
  ...
  fetchPlants: () => {
    ...
    axios.get('https://localhost:7246/plants', {
        headers: {
  ...
  fetchRankedPlants: () => {
    ...
    axios.get('https://localhost:7246/plants/ranked', {
        headers: {
          Authorization: GetToken()
        }
      })
  ...
  fetchPlantById: (id) => {
    ...
    axios.get(`https://localhost:7246/plants/${id}`, {
        headers: {
          Authorization: GetToken()
        }
      })
  ...
  recognizePlant: (base64Image, filename) => {
      ...
      axios.post('https://localhost:7246/plants/recognize', {
        "fileName": filename,
  ...
  updatePlantById: (data, id) => {
    axios.put(`https://localhost:7246/plants/${id}`, data , {
        headers: {
          Authorization: GetToken()
        }
      })
  ...
  addPlant: (data, fetchPlants) => {
    ...
    axios.post('https://localhost:7246/plants', data, {
      headers: {
        Authorization: GetToken()
      }
    })
  ...
  deletePlant: (id, fetchPlants) => {
    ...
    axios.delete(`https://localhost:7246/plants/${id}`, {
      headers: {
        Authorization: GetToken()
      }
    })
